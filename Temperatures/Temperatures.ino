...
uint8_t sensor2[8] = { 0x28, 0x8C, 0xA2, 0x8B, 0x31, 0x21, 0x03, 0xE6 };
uint8_t sensor3[8] = { 0x28, 0x85, 0x87, 0x94, 0x31, 0x21, 0x03, 0xF8 };
uint8_t sensor4[8] = { 0x28, 0x3D, 0x41, 0x9D, 0x31, 0x21, 0x03, 0x73 };
uint8_t sensor5[8] = { 0x28, 0x08, 0x7D, 0xAB, 0x31, 0x21, 0x03, 0x91 };
uint8_t sensor6[8] = { 0x28, 0xEB, 0x5B, 0x88, 0x31, 0x21, 0x03, 0x7D };
uint8_t sensor7[8] = { 0x28, 0x87, 0x7C, 0x97, 0x31, 0x21, 0x03, 0xC8 };
uint8_t sensor8[8] = { 0x28, 0x58, 0x8A, 0x99, 0x31, 0x21, 0x03, 0x07 };
